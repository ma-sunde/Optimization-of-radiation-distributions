...
def run_unreal_executable(executable_dir):
    ...
    with open("unreal_engine/Execution_Command_with_Args_Advanced.txt", "r") as f:
...
if __name__ == "__main__":
    executable_dir = r"C:/Users/grabe/Documents/Rayen/light_distribution_optimization/unreal_engine/UE_Light_Sim_Screenshot_Advanced_Exe/Windows/UE_Light_Sim.exe"
