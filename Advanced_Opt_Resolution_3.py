...
class SaveStudyCallback:
    ...
    def __call__(self, study: optuna.study.Study, trial: optuna.trial.FrozenTrial) -> None:
        i = trial.number
        if i % 50 == 0:
            joblib.dump(study, f"C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/studies_advanced/Study_Level_3_Startup/Study_{i}.pkl")
...
class SaveBestResultCallback:
    ...
    def __call__(self, study, trial):
        if study.best_trial == trial:
            ...
            df_result.to_csv(f"C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/studies_advanced/Study_Level_3_Startup/Object_Detection_Best_Results_{i}.csv", index=False)
...
def objective(trial):
    ...
    ld1_it3 = trial.suggest_uniform("ld1_it3", 0, 1)
    ld2_it3 = trial.suggest_uniform("ld2_it3", 0, 1)
    ld3_it3 = trial.suggest_uniform("ld3_it3", 0, 1)
    ld4_it3 = trial.suggest_uniform("ld4_it3", 0, 1)
    
    # Create the four 4x4 arrays with the optimized values
    arr1_it3 = np.full((4, 4), ld1_it3)
    arr2_it3 = np.full((4, 4), ld2_it3)
    arr3_it3 = np.full((4, 4), ld3_it3)
    arr4_it3 = np.full((4, 4), ld4_it3)

    # Create arr_it2
    arr_it3 = np.concatenate([np.concatenate([arr1_it3, arr2_it3], axis=1), np.concatenate([arr3_it3, arr4_it3], axis=1)], axis=0)
...
if __name__ == "__main__":
    #log_dir = r"C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/studies_advanced/Study_Level_3_Startup/TB_Log"
    ...
    joblib.dump(study, "C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/studies_advanced/Study_Level_3_Startup/Study.pkl")
    ...
    # Write images
    fig_acc.write_image("C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/studies_advanced/Study_Level_3_Startup/Graphs/fig_acc.svg")
    fig_hist.write_image("C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/studies_advanced/Study_Level_3_Startup/Graphs/fig_hist.svg")
    fig_importance.write_image("C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/studies_advanced/Study_Level_3_Startup/Graphs/fig_importance.svg")
