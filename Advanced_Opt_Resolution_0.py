...
class SaveStudyCallback:
    ...
    def __call__(self, study: optuna.study.Study, trial: optuna.trial.FrozenTrial) -> None:
        i = trial.number
        if i % 50 == 0:
            joblib.dump(study, f"C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/studies_advanced/Study_Level_0_Startup/Study_{i}.pkl")
...
class SaveBestResultCallback:
    ...
    def __call__(self, study, trial):
        if study.best_trial == trial:
            ...
            df_result.to_csv(f"C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/studies_advanced/Study_Level_0_Startup/Object_Detection_Best_Results_{i}.csv", index=False)


def objective(trial):
    # Define the light distribution as a set of hyperparameters
    ld1 = trial.suggest_uniform("ld1", 0, 1)
    ld2 = trial.suggest_uniform("ld2", 0, 1)
    ld3 = trial.suggest_uniform("ld3", 0, 1)
    ld4 = trial.suggest_uniform("ld4", 0, 1)
    
    # Create the four 4x4 arrays with the optimized values
    arr1 = np.full((32, 32), ld1)
    arr2 = np.full((32, 32), ld2)
    arr3 = np.full((32, 32), ld3)
    arr4 = np.full((32, 32), ld4)
...
if __name__ == "__main__":
    #log_dir = r"C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/studies_advanced/Study_Level_0_Startup/TB_Log"
    ...
    joblib.dump(study, "C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/studies_advanced/Study_Level_0_Startup/Study.pkl")
    ...
    # Write images
    fig_acc.write_image("C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/studies_advanced/Study_Level_0_Startup/Graphs/fig_acc.svg")
    fig_hist.write_image("C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/studies_advanced/Study_Level_0_Startup/Graphs/fig_hist.svg")
    fig_importance.write_image("C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/studies_advanced/Study_Level_0_Startup/Graphs/fig_importance.svg")
