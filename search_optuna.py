...
class SaveStudyCallback:
    ...
    def __call__(self, study: optuna.study.Study, trial: optuna.trial.FrozenTrial) -> None:
        i = trial.number
        if i % 100 == 0:
            joblib.dump(study, f"C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/initial_studies/TPE_Study_2/Study_{i}.pkl")

def objective(trial):
    # Define the light distribution as a set of hyperparameters
    light_distribution = [
        trial.suggest_uniform(f"LI_{i}", 0, 1) for i in range(64)
    ]
    ...
    #penalty = np.mean(light_distribution_np_array)
...
if __name__ == "__main__":
    #log_dir = r"C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/initial_studies/TPE_Study_2/TB_Log"
    ...
    joblib.dump(study, "C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/initial_studies/TPE_Study_2/Study.pkl")
    ...
    # Write images
    fig_acc.write_image("C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/initial_studies/TPE_Study_2/Graphs/fig_acc.svg")
    fig_hist.write_image("C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/initial_studies/TPE_Study_2/Graphs/fig_hist.svg")
    fig_importance.write_image("C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/initial_studies/TPE_Study_2/Graphs/fig_importance.svg")
