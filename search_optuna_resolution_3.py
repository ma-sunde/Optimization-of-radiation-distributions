...
class SaveStudyCallback:
    ...
    def __call__(self, study: optuna.study.Study, trial: optuna.trial.FrozenTrial) -> None:
        i = trial.number
        if i % 100 == 0:
            joblib.dump(study, f"C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/studies/Study_33/Study_{i}.pkl")
...
def objective(trial):
    ...
    ld4_2 = 0.7140396218792096
    ld4_3 = 0.9298231120448119
    ld4_4 = 0.29954236896331315
    ...
    ld4_1_1 = trial.suggest_uniform("ld4_1_1", 0, 1)
    ld4_1_2 = trial.suggest_uniform("ld4_1_2", 0, 1)
    ld4_1_3 = trial.suggest_uniform("ld4_1_3", 0, 1)
    ld4_1_4 = trial.suggest_uniform("ld4_1_4", 0, 1)

    arr4_1_1 = np.full((1, 1), ld4_1_1)
    arr4_1_2 = np.full((1, 1), ld4_1_2)
    arr4_1_3 = np.full((1, 1), ld4_1_3)
    arr4_1_4 = np.full((1, 1), ld4_1_4)

    arr4_1 = np.concatenate([np.concatenate([arr4_1_1, arr4_1_2], axis=1), np.concatenate([arr4_1_3, arr4_1_4], axis=1)], axis=0)
    ...
    penalty = (ld1 + ld2 + ld3 + (ld4_2 + ld4_3 + ld4_4 + (ld4_1_1 + ld4_1_2 + ld4_1_3 + ld4_1_4)/4)/4)/4
...
if __name__ == "__main__":
    #log_dir = r"C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/studies/Study_33/TB_Log"
    ...
    joblib.dump(study, "C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/studies/Study_33/Study.pkl")
    ...
    # Write images
    fig_acc.write_image("C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/studies/Study_33/Graphs/fig_acc.svg")
    fig_hist.write_image("C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/studies/Study_33/Graphs/fig_hist.svg")
    fig_importance.write_image("C:/Users/grabe/Documents/Rayen/light_distribution_optimization/optuna/studies/Study_33/Graphs/fig_importance.svg")
